        ...
        <div class="row mb-5">
            <div class="col-md pt-5">
                <div class="ftco-footer-widget pt-md-5 mb-4">
                    ...
                    <p>Website T-Travel cho phép đặt các tour du lịch trong vào ngoài nước.</p>
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft">
                        <li class="ftco-animate"><a href="https://www.facebook.com/profile.php?id=100087388887674"><span class="fa fa-facebook"></span></a></li>
            ...
            <div class="col-md pt-5 border-left">
                <div class="ftco-footer-widget pt-md-5 mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon fa fa-map-marker"></span><span class="text"> Đà Nẵng</span></li>
                            <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">0123456789</span></a></li>
                            <li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text">T-Travel@gmail.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
