<div>
  ...
  border-width: 5px;">
        <h4  style="background-color:#c5ffff;text-align: center;border-color: green; border-style: solid;
        border-width: 5px;">Cảm ơn quý khách đã sử dụng dịch vụ của chúng tôi,<br>
